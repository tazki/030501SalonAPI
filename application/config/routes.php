...
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
$route['detail/([a-zA-Z0-9_-]+)'] = 'home/detail/$1';
...
$route['api/member/country'] = 'api/member/country';
$route['api/member/(:num)'] = 'api/member/index/id/$1';
$route['api/post/([a-zA-Z0-9_-]+)'] = 'api/post/index/q/$1';
$route['api/post/detail/(:num)'] = 'api/post/detail/id/$1';
